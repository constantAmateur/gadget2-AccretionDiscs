...
base="/home/myoung/Output/Production/r_5_q_0.2_epsilon_0.01_minusDensityPower_2_beta_25_alphaSPH_0.2_betaSPH_4.0_MM_noBS"
...
dat=[[100000,"N_1e5"],[20000,"N_2e5"],[5000000,"N_5e6"]]
dat=[100000,["N_2e5","N_5e6"]]
...
#Add guiding lines
speedup.plot(np.log2(speedup.bigx),np.log2(speedup.bigx)-np.log2(speedup.bigx[0]),'k--',label="Perfect scaling")
